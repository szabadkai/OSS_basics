...
function init_planet_tile_config() {
    ...
    desert_config.tiles = {};
    desert_config.tiles.base = 148;      // Sand tile (most common - 60%)
    desert_config.tiles.feature = 74;   // Rock formations (30%)
    desert_config.tiles.center = 184;    // Ancient ruins (center piece)
    desert_config.tiles.rare = 164;      // Additional ruins/artifacts (10%)
